...
import 'package:Pretty/Modules/ServiceProviderProfile/service_provider_profile_controller.dart';
...
class ServiceProviderProfileScreen extends StatefulWidget {
  static const routeName = "ServiceProviderProfile";
...
class ServiceProviderProfileScreenState
    extends StateMVC<ServiceProviderProfileScreen> {
  ServiceProviderProfileScreenState()
      : super(ServiceProviderProfileController()) {
    con = ServiceProviderProfileController();
  }

  late ServiceProviderProfileController con;
  int activeText = 0;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: const ServiceBottomNavBarWidget(
        selected: ServiceSelectedBottomNavBar.profile,
      ),
      body: SafeArea(
        child: LoadingScreen(
          loading: con.loading,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        context.pushNamed(
                                            ServiceProviderPersonalDataScreen.routeName);
                                      },
                                      child: Text(
                                        Strings.editPersonalData.tr,
