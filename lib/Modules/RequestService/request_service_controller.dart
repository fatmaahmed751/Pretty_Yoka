...
class RequestServiceController extends ControllerMVC {
  // singleton
  factory RequestServiceController() {
    _this ??= RequestServiceController._();
    return _this!;
  }

  static RequestServiceController? _this;

  RequestServiceController._();
