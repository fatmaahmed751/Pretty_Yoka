...
class VerificationUserScreen extends StatefulWidget {
  static const routeName = "VerificationUser";
  ...
  @override
  createState() => _VerificationUserScreenState();
}

class _VerificationUserScreenState extends StateMVC<VerificationUserScreen> {
  _VerificationUserScreenState() : super(VerificationUserOtpController()) {
    con = VerificationUserOtpController();
  }
  late VerificationUserOtpController con;
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();

  @override
  void initState() {
    super.initState();
    print("VerificationUserScreen: Controller initialized");
    //  con = VerificationUserOtpController();
