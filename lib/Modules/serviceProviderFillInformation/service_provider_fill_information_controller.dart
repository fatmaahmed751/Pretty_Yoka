...
class ServiceProviderFillInformationController extends ControllerMVC {
  // singleton
  factory ServiceProviderFillInformationController() {
    _this ??= ServiceProviderFillInformationController._();
    return _this!;
  }

  static ServiceProviderFillInformationController? _this;

  ServiceProviderFillInformationController._();
