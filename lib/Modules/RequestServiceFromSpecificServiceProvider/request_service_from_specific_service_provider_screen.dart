...
import 'package:Pretty/Modules/RequestServiceFromSpecificServiceProvider/request_service_from_specific_service_provider_controller.dart';
...
class RequestServiceFromSpecificServiceProviderScreen extends StatefulWidget {
  static const routeName = "RequestServiceFromSpecificServiceProvider";
  const RequestServiceFromSpecificServiceProviderScreen({super.key});

  @override
  State createState() => RequestServiceFromSpecificServiceProviderScreenState();
}

class RequestServiceFromSpecificServiceProviderScreenState extends StateMVC<RequestServiceFromSpecificServiceProviderScreen> {
  RequestServiceFromSpecificServiceProviderScreenState() : super(RequestServiceFromSpecificServiceProviderController()) {
    con = RequestServiceFromSpecificServiceProviderController();
  }

  late RequestServiceFromSpecificServiceProviderController con;
  @override
