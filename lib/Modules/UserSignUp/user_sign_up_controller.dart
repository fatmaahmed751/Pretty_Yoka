...
class UserSignUpController extends ControllerMVC {
  // singleton
  factory UserSignUpController() {
    _this ??= UserSignUpController._();
    return _this!;
  }

  static UserSignUpController? _this;

  UserSignUpController._();
