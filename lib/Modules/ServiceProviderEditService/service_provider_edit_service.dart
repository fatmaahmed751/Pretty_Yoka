...
import 'package:Pretty/Modules/ServiceProviderEditService/service_provider_edit_service_controller.dart';
...
class ServiceProviderEditServiceScreen extends StatefulWidget {
  static const routeName = "ServiceProviderEditService";
  const ServiceProviderEditServiceScreen({super.key});

  @override
  createState() => _ServiceProviderEditServiceScreenState();
}

class _ServiceProviderEditServiceScreenState extends StateMVC<ServiceProviderEditServiceScreen> {
  _ServiceProviderEditServiceScreenState() : super(ServiceProviderEditServiceController()) {
    con = ServiceProviderEditServiceController();
  }

  late ServiceProviderEditServiceController con;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomMainSideTextWidget(
                          text:
                          //con.allMainService[con.selectedJobIndex].name == "Beauty Specialist" ||
