...
import 'package:Pretty/Utilities/theme_helper.dart';
...
class TextStyleHelper{
  ...
  TextStyle get h_15 => getTextStyle(fontSize: 20,fontWeight: FontWeight.w500);
  TextStyle get h_13 => getTextStyle(fontSize: 16,fontWeight: FontWeight.w500);

  TextStyle get b_15 => getTextStyle(fontSize:12,fontWeight: FontWeight.w500);
  TextStyle get b_21 => getTextStyle(fontSize: 20,fontWeight: FontWeight.w500);
  ...
  TextStyle get b_17 => getTextStyle(fontSize: 14,fontWeight: FontWeight.w500);
